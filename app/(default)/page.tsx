    ...
    <>
      <BackgroundLines>
        <div className="flex flex-col items-center justify-center min-h-screen w-full text-center px-4 sm:px-6 lg:px-8 -mt-60 sm:-mt-28 md:-mt-32"> {/* Increased negative margin for mobile */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-3xl mx-auto bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 pb-2 sm:pb-6">
            {siteConfig.title}
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-neutral-500 dark:text-neutral-400 max-w-3xl mx-auto mt-2 sm:mt-4">
