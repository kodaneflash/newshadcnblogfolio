...
export default function Home() {
  return (
    <>
      <BackgroundLines>
        <div className="flex flex-col items-center justify-center min-h-screen w-full text-center px-4 sm:px-6 lg:px-8 -mt-40 sm:-mt-28 md:-mt-32"> {/* Reduced negative margin for mobile */}
